...
const UNB = (function(){
  ...
  /* ==========================================================================
     二之二、動效層 UNFx(v2.5.0)—— 動作牌的特寫 · 罰抽能量球 · 宣告光柱
     ──────────────────────────────────────────────────────────────────────────
  ...
  function tableHTML(o){
    ...
    /* ⚠ 方向的箭頭用**幾何字元**(U+25B8 / U+25C2)而不是迴轉箭頭(U+21BB / U+21BA)——
       ...
       ★★ **2 人局不畫方向**(v1.109.0):兩個人的桌上「順向」與「逆向」是同一件事,
          ...
          改變,正是使用者說的「很像工程用的東西」。 */
    /* ★ 方向換了的那一次讓膠囊自己翻一圈(v2.5.0)—— 「迴轉」最常見的抱怨是
    ...
    /* ★★ 罰抽膠囊升級成**能量球**(v2.5.0):數字越大顏色越燙,而且**只有變多的
       那一次**會撞一下(`.grow`)。
