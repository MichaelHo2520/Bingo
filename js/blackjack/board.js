...
const BJB = (function(){
  ...
  /* ⚠ `m` 是**純畫面**的動效記號(v2.5.0,見六之三):`m.just` 起的那幾張是這一次
  ...
  function boxHTML(v, s, basis){
    ...
    if(turn) cls += " act";
    /* ★ 停手 = 這一格**定型了**(v2.5.0)。舊版只有右邊一個很小的「✋停」,
  ...
  function announce(v){
    ...
    /* ★ 特寫跟著**同一個 snd** 走(v2.5.0)—— 聲音與畫面共用一份優先權,
